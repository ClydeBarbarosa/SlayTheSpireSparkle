...
import static sparklemod.SparkleMod.characterPath;
import static sparklemod.SparkleMod.makeID;

public class SparkleCharacter extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("Sparkle"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass SPARKLE_CHARACTER;
        @SpireEnum(name = "CHARACTER_SPARKLE_COLOR") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "CHARACTER_SPARKLE_COLOR") @SuppressWarnings("unused")
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new SparkleCharacter(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
    ...
    public SparkleCharacter() {
        super(getNames()[0], Meta.SPARKLE_CHARACTER,
    ...
    public ArrayList<String> getStartingDeck() {
        ...
        //tester cards
        retVal.add(Flexibility.ID);
        retVal.add(JustAPeek.ID);
        retVal.add(JustATaste.ID);
        retVal.add(OnOneHandViolence.ID);
        retVal.add(OnTheOtherPatience.ID);
    ...
    public ArrayList<String> getStartingRelics() {
        ...
        retVal.add(SparkleKendamaBall.ID);
    ...
    private final Color cardRenderColor = Color.MAROON.cpy(); //Used for some vfx on moving cards (sometimes) (maybe)
    private final Color cardTrailColor = Color.MAROON.cpy(); //Used for card trail vfx during gameplay.
    private final Color slashAttackColor = Color.MAROON.cpy(); //Used for a screen tint effect when you attack the heart.
    @Override
