...
public class SparkleMaskEnergyGainPower extends BasePower {
    public static final String POWER_ID = makeID(SparkleMaskEnergyGainPower.class.getSimpleName());
    private static final AbstractPower.PowerType TYPE = AbstractPower.PowerType.BUFF;
    private static final boolean TURN_BASED = false;

    private int energyGain = 0;

    public SparkleMaskEnergyGainPower(AbstractCreature owner, int amount) {
