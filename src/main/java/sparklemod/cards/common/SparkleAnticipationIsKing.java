...
public class SparkleAnticipationIsKing extends BaseCard {
    public static final String ID = makeID(SparkleAnticipationIsKing.class.getSimpleName());
    ...
    public SparkleAnticipationIsKing () {
        super(ID, info);
